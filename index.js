        ...
        walk(layers, function (layer) {
            ...
            if (layer.kind === LayerKind.TEXT) {
                ...
                try {
                    ...
                    layerObj.lineHeight = textItem.leading;
                    layerObj.type = 'TEXT';
                }
                catch (e) {
                    console.log(e);
                ...
                // 限制一下大小，不然多大的图都切，切出来200M的图片谁受得了
                if (layerObj.width < 800 && layerObj.height < 800) {
...
// 把js放到ps里处理
ps.invoke(processPs, [process.cwd() + '/'], function(err, result){
    if (err) {
        console.log(err);
    }
